...
from MySubmittedCode import MyPlayer
import sys
import argparse
import timeit
...
if __name__ == "__main__":
    ...
    parser.add_argument("--player2", "-p2", type=str, help="White player. Options: manual, random, greedy, aggressive, smart, my", default='my')
    parser.add_argument("--times", "-t", type=int, help="playing times.", default=20)
