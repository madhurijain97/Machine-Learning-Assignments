    ...
    while(shouldStop == False):
        ...
        for i in range(gridSize):
            for j in range(gridSize):
                ...
                # temp_grid_val = max(tempUp, tempDown, tempRight, tempLeft)
...
if __name__ == "__main__":
    ...
    #inputTextFileName = os.path.basename(inputTextFileName)
    #inputTextFileName = 'blackbox51.txt'
