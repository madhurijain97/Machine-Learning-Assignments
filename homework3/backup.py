...
def plotGraph(accuracyListForGraph):
    fig = pyplot.figure()
    pyplot.plot(accuracyListForGraph)
    fig.suptitle('Accuracy Graph', fontsize=20)
    pyplot.xlabel('Training Times', fontsize=18)
    pyplot.ylabel('Test Accuracy', fontsize=16)
    pyplot.show()
...
if __name__ == "__main__":
    ...
    plotGraph(accuracyListForGraph)
